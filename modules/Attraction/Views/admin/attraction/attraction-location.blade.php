<div class="panel">
    <div class="panel-title"><strong>{{__("Attraction Locations")}}</strong></div>
    <div class="panel-body">
        ...
        @endif
        <div class="form-group">
            <label class="control-label">{{__("Real attraction address")}}</label>
            <input type="text" name="address" class="form-control" placeholder="{{__("Real attraction address")}}" value="{{$translation->address}}">
        </div>
        @if(is_default_lang())
            <div class="form-group">

<form action="{{url( app_get_locale(false,false,'/').config('attraction.attraction_route_prefix') )}}" class="form bravo_form d-flex justify-content-start" method="get" onsubmit="return false;">

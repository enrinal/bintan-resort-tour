...
@include('Attraction::frontend.layouts.details.tour-include-exclude')
...
@include('Attraction::frontend.layouts.details.tour-itinerary')
@include('Attraction::frontend.layouts.details.tour-attributes')
{{-- @include('Attraction::frontend.layouts.details.tour-faqs') --}}

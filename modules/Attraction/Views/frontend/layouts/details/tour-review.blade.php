            ...
            <div class="form-wrapper">
                ...
                <form action="{{ url(app_get_locale()."/review") }}" class="needs-validation" novalidate method="post">
                    ...
                    <div class="row">
                        ...
                        @if($attraction_review_stats = setting_item("attraction_review_stats"))
                            @php $attraction_review_stats = json_decode($attraction_review_stats) @endphp
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group review-items">
                                    @foreach($attraction_review_stats as $item)
                                        <div class="item">
                    ...
                    <div class="text-center">
                        ...
                        <input type="hidden" name="review_service_type" value="attraction">

<div class="bravo_filter">
    <form action="{{url(app_get_locale(false,false,'/').config('attraction.attraction_route_prefix'))}}" class="bravo_form_filter">
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                <div class="bravo-filter-price">
                    <?php
                    $price_min = $pri_from = $attraction_min_max_price[0];
                    $price_max = $pri_to = $attraction_min_max_price[1];
        ...
        <div class="g-filter-item">
            ...
            <div class="item-content">
                ...
                @if(count($attraction_category) > 3 and empty($current_category_ids))

...
@section('content')
    <div class="bravo_search_tour">
        <div class="bravo_form_search_map">
            @include('Attraction::frontend.layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map">
            ...
            <div class="results_item">
                @include('Attraction::frontend.layouts.search-map.advance-filter')
                <div class="listing_items">
                    @include('Attraction::frontend.layouts.search-map.list-item')
                </div>
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script type="text/javascript" src="{{ asset('module/attraction/js/attraction-map.js?_ver='.config('app.version')) }}"></script>
@endsection
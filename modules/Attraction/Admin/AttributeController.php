...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'attraction');
        ...
        return view('Attraction::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'attraction')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Attraction'),
        ...
        return view('Attraction::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Attraction::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/attraction/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Attraction::admin.terms.detail', $data);
    }

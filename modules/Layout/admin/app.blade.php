...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Bintan Resorts Tour'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Admin Dashboard')}} <a href="{{__('#')}}" target="_blank">{{__('Bintan Resort Team')}}</a>
                    </div>
                    <div class="col-md-6">

<div class="panel">
    <div class="panel-title"><strong>{{__("Merchandise Content")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{__("Title")}}</label>
            <input type="text" value="{{$translation->title}}" placeholder="{{__("Name of the merchandise")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
